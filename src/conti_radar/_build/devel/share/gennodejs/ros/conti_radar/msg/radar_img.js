...
class radar_img {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.x_dist, buffer, bufferOffset, null);
    // Serialize message field [y_dist]
    bufferOffset = _arraySerializer.float32(obj.y_dist, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.x_dist = _arrayDeserializer.float32(buffer, bufferOffset, null)
    // Deserialize message field [y_dist]
    data.y_dist = _arrayDeserializer.float32(buffer, bufferOffset, null)
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.x_dist.length;
    length += 4 * object.y_dist.length;
  ...
  static md5sum() {
    ...
    return '2424b37a84bb8c7ac2a31975aa8f6c05';
  }
