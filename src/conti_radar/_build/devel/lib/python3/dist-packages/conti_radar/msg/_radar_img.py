...
class radar_img(genpy.Message):
  _md5sum = "2424b37a84bb8c7ac2a31975aa8f6c05"
...
float32[] SNR
"""
  __slots__ = ['id','range','azimuth','x_dist','y_dist','VrelRad','RCS','rangevar','vrelradvar','azimuthvar','SNR']
  _slot_types = ['int32','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,range,azimuth,x_dist,y_dist,VrelRad,RCS,rangevar,vrelradvar,azimuthvar,SNR
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.x_dist)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.x_dist))
      length = len(self.y_dist)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.y_dist))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.x_dist = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.y_dist = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.x_dist.tostring())
      length = len(self.y_dist)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.y_dist.tostring())
      length = len(self.VrelRad)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.x_dist = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.y_dist = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
