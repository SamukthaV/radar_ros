...
struct radar_img_
{
  ...
  _azimuth_type azimuth;
   ...
   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _x_dist_type;
  _x_dist_type x_dist;

   typedef std::vector<float, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<float>> _y_dist_type;
  _y_dist_type y_dist;
...
struct MD5Sum< ::conti_radar::radar_img_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x2424b37a84bb8c7aULL;
  static const uint64_t static_value2 = 0xc2a31975aa8f6c05ULL;
};
...
struct Printer< ::conti_radar::radar_img_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::conti_radar::radar_img_<ContainerAllocator>& v)
  {
    ...
    s << indent << "x_dist[]" << std::endl;
    for (size_t i = 0; i < v.x_dist.size(); ++i)
    {
      s << indent << "  x_dist[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.x_dist[i]);
    }
    s << indent << "y_dist[]" << std::endl;
    for (size_t i = 0; i < v.y_dist.size(); ++i)
    {
      s << indent << "  y_dist[" << i << "]: ";
      Printer<float>::stream(s, indent + "  ", v.y_dist[i]);
    }
