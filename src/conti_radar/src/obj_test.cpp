...
#ippsnclude "pdk_RadarObjectList.pb.h"
#include <map>
#include <cstdio>
#include <vector>
#include <iostream>
...
int main(int argc, char *argv[])
{
    ...
    ros::NodeHandle nh;
    rad_test = nh.advertise<conti_radar::rad_test>("rad_test", 10000);
